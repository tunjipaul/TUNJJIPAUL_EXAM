...
while True:
    try:
     ...
     if choice == "1":
         ...
         print(f"Celsius -> Kelvin: {celsius_to_kelvin(round(temp,2))} kelvin")
     elif choice == "3":
         print(f"Farenheit -> Celsius: {farenheit_to_celsius(round(temp,2))} celsius")
     elif choice == "4":
         print(f"Farenheit -> Kelvin: {farenheit_to_kelvin(temp):.2f} kelvin")
     elif choice == "5":
         print(f"Kelvin -> Celsius: {kelvin_to_celsius(round(temp,2))} celsius")
     elif choice == "6":
